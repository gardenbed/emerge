...
func (m *mappers) ToCharRange(r comb.Result) (comb.Result, bool) {
	...
	val, chars := runeRangesToAlt(false, [2]rune{low, up})
...
func (m *mappers) ToASCIICharClass(r comb.Result) (comb.Result, bool) {
	...
	switch class {
	case "[:blank:]":
		val, chars = runesToAlt(false, ' ', '\t')
	case "[:space:]":
		val, chars = runesToAlt(false, ' ', '\t', '\n', '\r', '\f', '\v')
	case "[:digit:]":
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'})
	case "[:xdigit:]":
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'}, [2]rune{'A', 'F'}, [2]rune{'a', 'f'})
	case "[:upper:]":
		val, chars = runeRangesToAlt(false, [2]rune{'A', 'Z'})
	case "[:lower:]":
		val, chars = runeRangesToAlt(false, [2]rune{'a', 'z'})
	case "[:alpha:]":
		val, chars = runeRangesToAlt(false, [2]rune{'A', 'Z'}, [2]rune{'a', 'z'})
	case "[:alnum:]":
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'}, [2]rune{'A', 'Z'}, [2]rune{'a', 'z'})
	case "[:word:]":
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'}, [2]rune{'A', 'Z'}, [2]rune{'_', '_'}, [2]rune{'a', 'z'})
	case "[:ascii:]":
		val, chars = runeRangesToAlt(false, [2]rune{0x00, 0x7f})
	default:
...
func (m *mappers) ToCharClass(r comb.Result) (comb.Result, bool) {
	...
	case `\d`:
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'})
	case `\D`:
		val, chars = runeRangesToAlt(true, [2]rune{'0', '9'})
	case `\s`:
		val, chars = runesToAlt(false, ' ', '\t', '\n', '\r', '\f')
	case `\S`:
		val, chars = runesToAlt(true, ' ', '\t', '\n', '\r', '\f')
	case `\w`:
		val, chars = runeRangesToAlt(false, [2]rune{'0', '9'}, [2]rune{'A', 'Z'}, [2]rune{'_', '_'}, [2]rune{'a', 'z'})
	case `\W`:
		val, chars = runeRangesToAlt(true, [2]rune{'0', '9'}, [2]rune{'A', 'Z'}, [2]rune{'_', '_'}, [2]rune{'a', 'z'})
	default:
		return comb.Result{}, false
	}
